  ...
  return (
    <section id="cta" className="py-16 md:py-24 bg-gray-950">
      <div className="container mx-auto px-4 md:px-6">
        <div className="relative overflow-hidden rounded-2xl bg-gray-900/80 backdrop-blur-sm border border-orange-400/20 p-8 md:p-12 shadow-2xl shadow-black/50">
          <div aria-hidden="true" className="absolute inset-0 -z-10">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2/3 h-2/3 bg-orange-500/10 blur-3xl rounded-full" />
          </div>
